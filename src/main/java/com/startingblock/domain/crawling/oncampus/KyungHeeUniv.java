...
import static com.startingblock.domain.crawling.oncampus.constant.KyungHeeConstant.DATE1;
import static com.startingblock.domain.crawling.oncampus.constant.KyungHeeConstant.DATE2;
import static com.startingblock.domain.crawling.oncampus.constant.KyungHeeConstant.TITLE1;
import static com.startingblock.domain.crawling.oncampus.constant.KyungHeeConstant.TITLE2;
import static com.startingblock.domain.crawling.oncampus.constant.KyungHeeConstant.URL;
import static com.startingblock.domain.crawling.oncampus.constant.KyungHeeConstant.VISIBLE;

@Service
@Slf4j
public class KyungHeeUniv extends CampusClassify implements CampusCrawling {

    private final AnnouncementRepository announcementRepository;
    public List<Announcement> announcementList = new ArrayList<>();

    public KyungHeeUniv(final AnnouncementRepository announcementRepository) {
    ...
    public List<Announcement> onCampusCrawling() {
        ...
        try {
            ...
            for (int i = 1; i <= 10; i++) {
                ...
                announcementList.add(CampusAnnouncementCreator.createCampusAnnouncement(title, dateTime, detailUrl, University.KYUNG_HEE, keyword));
