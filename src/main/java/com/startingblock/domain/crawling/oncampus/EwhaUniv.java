...
import static com.startingblock.domain.crawling.oncampus.constant.EwhaConstant.DATE1;
import static com.startingblock.domain.crawling.oncampus.constant.EwhaConstant.DATE2;
import static com.startingblock.domain.crawling.oncampus.constant.EwhaConstant.TITLE1;
import static com.startingblock.domain.crawling.oncampus.constant.EwhaConstant.TITLE2;
import static com.startingblock.domain.crawling.oncampus.constant.EwhaConstant.VISIBLE;
import static com.startingblock.domain.crawling.oncampus.constant.EwhaConstant.URL;

@Service
@Slf4j
public class EwhaUniv extends CampusClassify implements CampusCrawling {

    private final AnnouncementRepository announcementRepository;
    public List<Announcement> announcementList = new ArrayList<>();

    public EwhaUniv(final AnnouncementRepository announcementRepository) {
    ...
    public List<Announcement> onCampusCrawling() {
        ...
        try {
            ...
            for (int i = 1; i <= 10; i++) {
                ...
                announcementList.add(CampusAnnouncementCreator.createCampusAnnouncement(title, dateTime, detailUrl, University.EWHA, keyword));
