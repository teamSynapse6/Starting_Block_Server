...
import static com.startingblock.domain.crawling.oncampus.constant.KonKukConstant.URL;
import static com.startingblock.domain.crawling.oncampus.constant.KonKukConstant.TITLE1;
import static com.startingblock.domain.crawling.oncampus.constant.KonKukConstant.TITLE2;
import static com.startingblock.domain.crawling.oncampus.constant.KonKukConstant.DATE1;
import static com.startingblock.domain.crawling.oncampus.constant.KonKukConstant.DATE2;
import static com.startingblock.domain.crawling.oncampus.constant.KonKukConstant.VISIBLE;

@Service
@Slf4j
public class KonKukUniv extends CampusClassify implements CampusCrawling {

    private final AnnouncementRepository announcementRepository;
    public List<Announcement> announcementList = new ArrayList<>();

    public KonKukUniv(final AnnouncementRepository announcementRepository) {
    ...
    public List<Announcement> onCampusCrawling() {
        ...
        try {
            ...
            for (int i = 1; i <= 10; i++) {
                ...
                announcementList.add(CampusAnnouncementCreator.createCampusAnnouncement(title, dateTime, detailUrl, University.KON_KUK, keyword));
