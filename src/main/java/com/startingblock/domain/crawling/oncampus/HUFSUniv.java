...
public class HUFSUniv extends CampusClassify implements CampusCrawling {
    ...
    public HUFSUniv(final AnnouncementRepository announcementRepository) {
    ...
    public List<Announcement> onCampusCrawling() {
        ...
        try {
            ...
            for (int i = 1; i <= 10; i++) {
                ...
                announcementList.add(CampusAnnouncementCreator.createCampusAnnouncement(title, dateTime, detailUrl, University.HUFS, keyword));
