package com.startingblock.global.config.security.auth;

import java.util.Map;

import com.startingblock.global.DefaultAssert;
import com.startingblock.global.config.security.auth.company.Facebook;
import com.startingblock.global.config.security.auth.company.Github;
import com.startingblock.global.config.security.auth.company.Google;
import com.startingblock.global.config.security.auth.company.Kakao;
import com.startingblock.global.config.security.auth.company.Naver;
